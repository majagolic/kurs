...
public class Test {
	...
	public static void main(String[] args) {
		...
		private static void ispisPredmetaNaOsnovuBroja(Evidencija evidencija) {
			String brojStr;
			do {
				System.out.println("Broj: ");
				brojStr = scanner.nextLine();
			...
			evidencija.ispisNaOsnovuBroja(broj);
			
		}
		
		private static void ispisPredmetaNaOsnovuImena(Evidencija evidencija) {
			System.out.println("Naziv: ");
			String naziv = scanner.nextLine();
			evidencija.ispisNaOsnovuImena(naziv);
		}
		
		private static void dodajTekst(Evidencija evidencija) {
			String brojStr;
			do {
				System.out.println("Broj: ");
				brojStr = scanner.nextLine();
			...
			System.out.println("Tekst za dodavanje: ");
			String tekst =  scanner.nextLine();
			
			evidencija.dodajTekst(tekst, broj);
			}
		
		private static void ispisPredmetaUOpseguDatuma(Evidencija evidencija) {
			...
			do {
				...
				datumStrMin = scanner.nextLine();
			} while (!proveriDatum(datumStrMin));
			LocalDate datum1= LocalDate.parse(datumStrMin, dtf);
			
			String datumStrMax;
			do {
				System.out.println("Datum2: ");
				datumStrMax = scanner.nextLine();
			} while (!proveriDatum(datumStrMax));
			LocalDate datum2= LocalDate.parse(datumStrMax, dtf);
			
			
			evidencija.ispisPredmetaUOpseguDatuma(datum1, datum2);
		}
